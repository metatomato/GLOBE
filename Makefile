...
TARGETS = \
    ...
    GLOBE-Linux-Debug \
    GLOBE-Linux-DebugGame \
    GLOBE-Linux-Shipping \
    GLOBE-Linux-Test \
    GLOBE \
    GLOBEEditor-Linux-Debug \
    GLOBEEditor-Linux-DebugGame \
    GLOBEEditor-Linux-Shipping \
    GLOBEEditor-Linux-Test \
    GLOBEEditor
...
GLOBE-Linux-Debug:
	$(BUILD) GLOBE Linux Debug $(ARGS)

GLOBE-Linux-DebugGame:
	$(BUILD) GLOBE Linux DebugGame $(ARGS)

GLOBE-Linux-Shipping:
	$(BUILD) GLOBE Linux Shipping $(ARGS)

GLOBE-Linux-Test:
	$(BUILD) GLOBE Linux Test $(ARGS)

GLOBE:
	$(BUILD) GLOBE Linux Development $(ARGS)

GLOBEEditor-Linux-Debug:
	$(BUILD) GLOBEEditor Linux Debug $(ARGS)

GLOBEEditor-Linux-DebugGame:
	$(BUILD) GLOBEEditor Linux DebugGame $(ARGS)

GLOBEEditor-Linux-Shipping:
	$(BUILD) GLOBEEditor Linux Shipping $(ARGS)

GLOBEEditor-Linux-Test:
	$(BUILD) GLOBEEditor Linux Test $(ARGS)

GLOBEEditor:
	$(BUILD) GLOBEEditor Linux Development $(ARGS)
